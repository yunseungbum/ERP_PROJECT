...
namespace BuddyErp.Api.Migrations
{
    ...
    [Migration("20260729020406_AddDuesExecutionAndYearSummaryV2")]
    partial class AddDuesExecutionAndYearSummaryV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuddyErp.Api.Data.Entities.DuesYearSummary", b =>
                {
                    b.Property<long>("DuesYearSummaryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("DuesYearSummaryId");

                    b.HasIndex("DueYear")
                        .IsUnique();

                    b.ToTable("dues_year_summaries", (string)null);
                });
            ...
            modelBuilder.Entity("BuddyErp.Api.Data.Entities.MemberDueNote", b =>
                {
                    ...
                    b.Property<decimal>("ExecutionAmount")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(12)
                        .HasColumnType("decimal(12,0)")
                        .HasDefaultValue(0m)
